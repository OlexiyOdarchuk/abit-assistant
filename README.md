...
| `/lists` | Збережені аналізи *(в розробці)* |
| `/help`, `/about` | Довідка |
...
- [ ] Saved lists з deep-link sharing
- [ ] Summary-екран (місце, шанс, вердикт) після аналізу
- [ ] Manual toggle «це не конкурент»
- [ ] Гістограма балів картинкою
- [ ] `/admin` — broadcast, stats, refresh-cache
- [ ] Повноцінний EDBO драйвер (`vstup.edbo.gov.ua`)
- [ ] Docker scratch image + Compose

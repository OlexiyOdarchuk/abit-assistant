...
func (b *Bot) registerRoutes() {
	...
	for unique, h := range map[string]tele.HandlerFunc{
		...
		btnUniquePrioAddURL:            b.handlePrioAddURL,
		btnUniquePrioFromSaved:         b.handlePrioFromSaved,
		btnUniquePrioPickSaved:         b.handlePrioPickSaved,
		btnUniquePrioRemove:            b.handlePrioRemove,
		btnUniquePrioUp:                b.handlePrioUp,
		btnUniquePrioDown:              b.handlePrioDown,
		btnUniquePrioToggleUnlik:       b.handlePrioToggleUnlikely,
